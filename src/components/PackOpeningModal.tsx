          ...
          <div className="py-16 text-center space-y-8 relative overflow-hidden">
            {packType === "actor" ? (
              ...
              <>
                ...
                <div className="relative z-10 space-y-4">
                  <GlassesLogo className="h-20 w-20 text-purple-400 mx-auto animate-spin" style={{ animationDuration: '3s' }} />
              ...
              >
                ...
                <div className="p-4 space-y-2 bg-gradient-to-t from-background/95 to-background/80">
                  ...
                  <p className="text-sm text-muted-foreground flex items-center gap-2">
                    {packType === "actor" ? <Camera className="h-4 w-4" /> : <GlassesLogo className="h-4 w-4" />}
